class ProductSelector {
    ...
    sendPageViewEvent() {
        if (!this.pageViewSent) {
            ...
            if (typeof gtag !== 'undefined') {
                gtag('event', '6245_page_view_landing_var1');
            }
            
            // Yandex Metrika
            if (typeof ym !== 'undefined') {
                ym(96171108, 'reachGoal', '6245_page_view_landing_var1');
            }
    ...
    sendContinueClickEvent() {
        // Google Analytics
        if (typeof gtag !== 'undefined') {
            gtag('event', '6245_click_continue_var1');
        }
        
        // Yandex Metrika
        if (typeof ym !== 'undefined') {
            ym(96171108, 'reachGoal', '6245_continue_var1');
        }
    }
